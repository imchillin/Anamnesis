...
public class SceneFile : JsonFileBase
{
	...
	public void WriteToFile()
	{
		...
		//List<ObjectHandle<ActorMemory>> actors = TargetService.Instance.PinnedActors.Select(i => i.Memory!).ToList();
		...
		//this.CameraShot = new();
		//this.CameraShot.WriteToFile(CameraService.Instance, targetActor);
		...
		//foreach (ObjectHandle<ActorMemory> actor in actors)
		//{
